...
const LIVE_STATUS_META: Record<string, Meta> = {
  ...
  quota_exhausted: { color: 'warning', label: '限流中' },
  payment_required: { color: 'warning', label: '需要付费' },
  error: { color: 'error', label: '异常' },
  probe_failed: { color: 'error', label: '探测失败' },
  unknown: { color: 'error', label: '异常' },
  not_found: { color: 'error', label: '远端未发现' },
  remote_missing: { color: 'error', label: '远端未发现' },
  invalid: { color: 'error', label: '已失效' },
  unauthorized: { color: 'error', label: '未授权' },
  auth_error: { color: 'error', label: '未授权' },
  auth_failed: { color: 'error', label: '未授权' },
  account_deactivated: { color: 'error', label: '已失效' },
  account_deleted: { color: 'error', label: '已失效' },
  invalid_token: { color: 'error', label: '令牌失效' },
  access_token_invalidated: { color: 'error', label: '令牌失效' },
  token_invalidated: { color: 'error', label: '令牌失效' },
