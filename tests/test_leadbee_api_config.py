...
def test_connection_test_redacts_sensitive_product_metadata(monkeypatch):
            ...
            return {
                "data": {
                    "results": [
                        ...
                        {"id": "api_secret"},
                        {"id": "X-Signature"},
                        {"id": f"X-Signature:{'b4' * 32}"},
                        {"id": "Authorization:Bearer:token_fixture"},
                        {"id": "prefix-X-API-Key-suffix"},
                        {"id": "X-Timestamp:1723456789"},
                        {"id": "X-Nonce:nonce_fixture"},
                        {"id": "Idempotency-Key:request_fixture"},
                        {"id": "Set-Cookie:session_fixture"},
                        {"id": "X-Request-ID:trace_fixture"},
                        {"id": "prod-1"},
                        {"id": "sku_A.B/9:blue-2"},
                        {"id": "rapid-api-catalog-v2"},
                        {"id": "api-product-standard"},
                        {"id": "signature-product-v2"},
                        {"id": "123"},
                        {"id": "123456789"},
                    ]
                }
    ...
    assert result == {
        ...
        "product_ids": [
            "prod-1",
            "sku_A.B/9:blue-2",
            "rapid-api-catalog-v2",
            "api-product-standard",
            "signature-product-v2",
            "123",
            "123456789",
        ],
        "configured_product_available": True,
