...
- [x] **Step 3: Implement the minimal slot controller**
...
- [x] **Step 3: Implement one absolute mailbox budget**
...
- [x] **Step 3: Implement bounded sleeper-capable executors**
...
- [x] **Step 2: Scan the diff and logs for secrets**
